...
public class Spawner : MonoBehaviour
{
    ...
    //timer object
    //private GameObject timeObj = null;
    float remainingT;
    ...
    void Start()
    {
        ...
        /*if(timeObj == null)
        {
            timeObj = GameObject.FindWithTag("GameManager");
        }*/
   ...
   void WaveFinished()
    {
       // remainingT = FindObjectOfType<Timer>().remainingTime;
        Debug.Log("Wave done");
        state = SpawnerState.Counting;

        waveCountdown = timeBetween;
        remainingT = FindObjectOfType<Timer>().remainingTime + addedTime;
        FindObjectOfType<Timer>().remainingTime = remainingT;
